...
##
  class VibesApi
    ...
    carrier_file = File.exists?(File.expand_path("#{Dir.pwd}/config/carrier_codes.yml")) ?
                       File.expand_path("#{Dir.pwd}/config/carrier_codes.yml") : File.expand_path("../vibes/yaml/carrier_codes.yml", __FILE__)
    ...
    canada_area_codes_file = File.exists?(File.expand_path("#{Dir.pwd}/config/canada_area_codes.yml")) ?
                                 File.expand_path("#{Dir.pwd}/config/canada_area_codes.yml") : File.expand_path("../vibes/yaml/canada_area_codes.yml", __FILE__)
